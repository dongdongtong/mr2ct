...
class TranslationTrainer:
    ...
    def run_train_epoch(self, train_loader):
        ...
        for idx, batch in enumerate(train_loader):
            ...
            ct_brain_mask = self.reorganize_batch(batch['ct_brainmask'])
    ...
    def run_eval_epoch_loss(self, val_ds):
        ...
        for i in tqdm(range(len(val_ds))):
            ...
            windowed_loss_dict = self.get_windowed_loss(fake_ct, ct_img, ct_brainmask, "val")

            loss_G = loss_l1 + windowed_loss_dict['l1_loss_window_0_100'] + windowed_loss_dict['l1_loss_window_100_1500']
