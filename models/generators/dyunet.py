...
class DynUNet(nn.Module):
    ...
    def __init__(
        ...
        upsample_block: Optional[nn.Module] = None,
    ):
        super().__init__()
        ...
        self.upsample_block = upsample_block if upsample_block is not None else UnetUpBlock
    ...
    def get_upsamples(self):
        ...
        return self.get_module_list(
            ...
            kernel_size,
            strides,
            self.upsample_block,  # type: ignore
